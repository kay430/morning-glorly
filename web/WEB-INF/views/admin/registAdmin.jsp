                                ...
                                <div class="form-row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input class="form-control py-4" name="adminPno" type="text" placeholder="ex) 930101" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="small mb-1" for="inputLastName">이메일</label>
                                            <input class="form-control py-4" name="email" type="email" placeholder="이메일을 입력해주세요" />
                                        </div>
                                    </div>
                                </div>
