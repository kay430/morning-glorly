			...
			<div class="comment-wrapper">
				<div class="panel panel-info" style="barckground-color: red;">
					...
					<div class="panel-body">
						...
						<br>
						<button onclick="replyWrite(${sessionScope.questionAnswer.ansNo }, ${sessionScope.loginMember.id })" class="btn btn-primary pull-right">답변작성</button>
						...
						<ul id="reply__list" class="media-list">
							...
							<c:forEach var="replyDto" items="${ sessionScope.questionAnswer }">
							<!-- 댓글 아이템 -->
							<li class="media">	
								<img onerror="this.src='/blog/image/userProfile.png'" src="${replyDto.userProfile }" class="img-circle">		
								<div class="media-body">
									<strong class="text-primary">${ sessionScope.questionAnswer.mgAdDTO.id }</strong>
									<p>
										${ sessionScope.questionAnswer.ansBody }
									</p>
								</div>
							</li>
							</c:forEach>
