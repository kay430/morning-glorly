									...
									<table align="center">
										...
										<tr>
											...
											<td colspan="2"><textarea name="body" cols="60"
													rows="15" style="resize: none; width: 800px;" readonly></textarea>
											</td>
										</tr>
										<tr>
											<td>답변</td>
											<td colspan="2"><textarea name="body" cols="60" rows="2"
													style="resize: none; width: 800px;" required></textarea></td>
										</tr>
									</table>
									<br>
									<div align="center">
