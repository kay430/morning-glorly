...
public class QuestionPageInfoDTO implements java.io.Serializable{
	...
	public QuestionPageInfoDTO(int pageNo, int totalCount, int limit, int buttonAmount, int maxPage, int startPage,
	...
	public String toString() {
		return "QuestionPageInfoDTO [pageNo=" + pageNo + ", totalCount=" + totalCount + ", limit=" + limit
