...
public class OrderPageInfoDTO implements java.io.Serializable {
	...
	public OrderPageInfoDTO() {}

	public OrderPageInfoDTO(int pageNo, int totalCount, int limit, int buttonAmount, int maxPage, int startPage,
