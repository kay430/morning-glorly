...
public class SearchMemberAd extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		searchRd.getPageInfo().setTotalCount((new MemberService().searchMemberAdCount(searchRd)));
		searchRd.getPageInfo().setLimit(10);
		searchRd.getPageInfo().setButtonAmount(5);

		List<MgAdDTO> mgAdList = new MemberService().searchMemberAdList(Pagenation.getSearchPage(searchRd));
