...
public class QuestionDTO implements java.io.Serializable{
	...
	public String toString() {
		return "QuestionDTO [no=" + no + ", status=" + status + ", categoryNum=" + categoryNum + ", title=" + title
	...
	public QuestionDTO(int no, String status, int categoryNum, String title, String body, int writerMemberNo, int count,
